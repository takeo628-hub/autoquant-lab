...
def build() -> None:
    ...
    about = ("<h1>このサイトについて</h1>"
             ...
             "<h2>技術解説と開発物</h2>"
             "<p>システムの設計思想・実装・AIの自動運用ノウハウは"
             "<a href='https://zenn.dev/auto_quont' rel='me'>Zenn（@auto_quont）</a>で公開しています。</p>"
             "<ul><li><a href='https://zenn.dev/auto_quont/books/ai-autonomous-system'>"
             "書籍『AIに任せて壊れないシステムを作る』</a>（全6章・無料公開） — "
             "宣言ゲート、ルックアヘッドを構造で防ぐ設計、「改善したと見えて何も起きていない」"
             "バグの実例2件</li>"
             "<li><a href='https://github.com/takeo628-hub/jp-calendar-mcp'>jp-calendar-mcp</a>"
             " — 日本の営業日・祝日・和暦・税計算をAIエージェントから使えるMCPサーバー"
             "（MIT・依存ゼロ・テスト27件）</li></ul>"
